...
function Login({ onLogin, isAuthenticated }) {
  ...
  // LOGIN – now expects async onLogin that talks to backend
  ...
  // SIGNUP – call /api/auth/signup on your Node + Mongo backend
  ...
  return (
    <div className="page login-page login-page--constitution">
